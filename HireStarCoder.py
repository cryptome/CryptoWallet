...
candidate_database = {
    "Margaret": ["Margaret Hamilton", "0xBE1C2090EB289E5d998480d15dC6F5bDa5F913D5", "85", 1.25, "Images/MH.png"],
    "Ada": ["Ada Lovelace", "0x7dC340fdc8e519F7958C4a6143D6eA11eC96a814", "206", 3.33, "Images/AL.png"],
    "Grace": ["Grace Hopper", "0x0B442De8060006c45D3531307A9a0E1A06335fc7", "115", 1.15, "Images/GH.png"],
    "Evelyn": ["Evelyn Granville", "0xF2BB20fC88574093dEBdF1AD9F1dfEF807d5696E", "97", 2.22, "Images/EG.png"]
}

# A list of the FinTech Finder candidates first names
people = ["Margaret", "Ada", "Grace", "Evelyn"]
...
st.markdown("## Hire A Star Fintech Professional!")
st.text(" \n")
...
person = st.sidebar.selectbox('Select a Star Coder', people)

# Create a input field to record the number of hours the candidate worked
hours = st.sidebar.number_input("Contract Hours")

st.sidebar.markdown("## Star Coder Name, Hourly Rate, and Ethereum Address")
